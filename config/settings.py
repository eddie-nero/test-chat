...
SECRET_KEY = 'm(d1j+1-n!&i-n$)awk3d^w(obe46mmf7+hhat2c03fkg9@bk2'
...
# CELERY
RABBITMQ_DEFAULT_USER = os.environ.get(
    'RABBITMQ_DEFAULT_USER', default='guest')
RABBITMQ_DEFAULT_PASS = os.environ.get(
    'RABBITMQ_DEFAULT_PASS', default='guest')
RABBITMQ_HOST = os.environ.get('RABBITMQ_HOST', default='rabbit:5672')
