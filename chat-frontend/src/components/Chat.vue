                ...
                <template v-if="username === message.user.username">
                  ...
                  <div class="col-sm-2">
                    <img
                      ...
                      :src="`https://via.placeholder.com/40/007bff/fff&text=${message.user.username[0].toUpperCase()}`"
                    />
                  </div>
                </template>
                <template v-else>
                  <div class="col-sm-2">
                    <img
                      class="rounded-circle"
                      :src="`https://via.placeholder.com/40/333333/fff&text=${message.user.username[0].toUpperCase()}`"
                    />
                  </div>
                  <div class="col-sm-7">
...
export default {
  ...
  methods: {
    startChatSession() {
      $.post("http://localhost:8000/api/v1/chats/", (data) => {
        alert(
    ...
    joinChatSession() {
      ...
      $.ajax({
        url: `http://localhost:8000/api/v1/chats/${uri}/`,
